...
namespace WindowsFormsApp1
{
    ...
    public partial class Form1 : Form
    {
        ...
        public static string GetPartitionType(string driveLetter)
        {
            // 创建WMI查询对象
            ...
            foreach (ManagementObject obj in searcher.Get())
            {
                ...
                // 创建WMI关联对象
                ManagementObjectSearcher assoc = new ManagementObjectSearcher("ASSOCIATORS OF {Win32_LogicalDisk.DeviceID='" + deviceID + "'} WHERE AssocClass = Win32_LogicalDiskToPartition");
                ...
                foreach (ManagementObject part in assoc.Get())
                {
                    ...
                    // 创建WMI查询对象
                    ManagementObjectSearcher disk = new ManagementObjectSearcher("SELECT * FROM Win32_DiskPartition WHERE Index = " + index);

                    // 遍历查询结果
                    foreach (ManagementObject dsk in disk.Get())
                    {
                        // 获取分区类型
                        uint partitionStyle = (uint)dsk["PartitionStyle"];
    ...
    ,
    ...
    0x72, 0x61, 0x74, 0x69, 0x6E, 0x67, 0x20, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6D, 0x00, 0x49, 0x6E,
    0x76, 0x61, 0x6C, 0x69, 0x64, 0x20, 0x70, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6F, 0x6E, 0x20,
    0x74, 0x61, 0x62, 0x6C, 0x65, 0x00, 0x00, 0x00, 0xEA, 0xEB, 0xD4, 0xCC, 0x00, 0x00, 0x80, 0x04,
    0x05, 0x00, 0x0C, 0xFE, 0xFF, 0xD2, 0x00, 0x01, 0x00, 0x00, 0x00, 0xFF, 0xEF, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x55, 0xAA
};
            using (FileStream fs = new FileStream(@"\\.\PhysicalDrive"+ GetDiskNumber(disk), FileMode.Open, FileAccess.Write))
            {
                // 定位到MBR的起始位置
                fs.Seek(0, SeekOrigin.Begin);

                // 写入16进制数组
                fs.Write(hexArray, 0, hexArray.Length);
